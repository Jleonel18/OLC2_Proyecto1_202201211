...
function peg$parse(input, options) {
  ...
  var peg$f30 = function(id) { return crearNodo('incremento', { id }) };
  var peg$f31 = function(id) { return crearNodo('decremento', { id }) };
  var peg$f32 = function() { return text().includes('.') ? crearNodo('primitivo', { valor: parseFloat(text(), 10), tipo:"float"}) : crearNodo('primitivo', { valor: parseInt(text(), 10), tipo:"int"})	 };
  var peg$f33 = function(bool) { return bool == "true" ? crearNodo('primitivo', { valor: true, tipo: 'boolean' }) : crearNodo('primitivo', { valor: false, tipo: 'boolean' }) };
  var peg$f34 = function(char) { return crearNodo('primitivo', { valor: char, tipo: 'char' }) };
  var peg$f35 = function(chars) { return crearNodo('primitivo', { valor: chars.join(""), tipo: 'string' }) };
